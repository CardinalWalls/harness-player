---
name: hr
description: 'Guardian of team capability. When a lesson reveals a missing principle in an upstream skill/agent doc, route that lesson back into the correct file instead of patching the downstream artifact. Also audits skill/agent doc quality and dedupes. Use for /hr-style lesson routing and skill-level maintenance.'
metadata:
