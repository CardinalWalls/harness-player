---
name: story
description: 'Turn PRD plus ARCHITECTURE into a single self-contained development story with acceptance criteria, test scenarios, exact file paths, anti-patterns. The story file is the sole source of truth for Tester and Coder. Use when moving from architecture to implementable work.'
metadata:
