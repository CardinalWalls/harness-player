---
name: setup
description: 'Prepare a development environment for a story: git worktree creation, dependency verification, build checks. Optional — many developers skip this and work in the main checkout. Use when starting a new story that benefits from isolation.'
metadata:
