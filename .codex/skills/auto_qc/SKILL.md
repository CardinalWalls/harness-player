---
name: auto_qc
description: 'Auto-trigger the qc skill whenever a Tester or Coder sub-run reports completion. Use passively — the main agent loads this skill so QC fires without the user having to ask each time.'
metadata:
