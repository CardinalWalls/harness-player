...
These notes are Git-tracked research and clarification artifacts produced during OMX-driven discussion.

They are intended to serve as:

- clarification inputs during `deep-interview`
- grounded references for future `ralplan`
- durable memory for architecture, synthesis, and reuse-vs-implement decisions
